...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 30, 2025 lúc 04:42 PM
...
(62, 2, 'Dép nam quai ngang da PU', 'depnam1.jpg', '120000', '1', 'Giảm 10%', '1', 0, 'Dép nam thiết kế đơn giản, da PU mềm mại.'),
(63, 2, 'Dép nam đế tổ ong chống trượt', 'depnam2.jpg', '99000', '1', 'Mua 1 tặng 1', '1', 0, 'Đế chống trượt, thích hợp mang đi mưa.'),
(64, 2, 'Dép nam quai chéo bản lớn', 'depnam3.jpg', '135000', '1', 'Giảm 5%', '1', 1, 'Quai chéo chắc chắn, phong cách thể thao.'),
(65, 2, 'Dép nam da bò thật thủ công', 'depnam4.jpg', '289000', '1', 'Freeship toàn quốc', '1', 1, 'Chất liệu da bò thật, may thủ công.'),
(66, 2, 'Dép nam đế cao su êm ái', 'depnam5.jpg', '110000', '1', 'Giảm 15%', '1', 0, 'Đế cao su chống sốc, phù hợp đi chơi, dạo phố.'),
(67, 2, 'Dép nam xỏ ngón thể thao', 'depnam6.jpg', '125000', '1', 'Flash sale', '1', 0, 'Phong cách thể thao, phù hợp cho mùa hè.'),
(68, 2, 'Dép nam bản da trơn cao cấp', 'depnam7.jpg', '149000', '1', 'Tặng voucher 10k', '1', 1, 'Thiết kế sang trọng, phù hợp đi làm, đi chơi.'),
(69, 2, 'Dép nam quai vải dù bền đẹp', 'depnam8.jpg', '105000', '1', 'Mua 2 giảm 20k', '1', 0, 'Quai vải bền chắc, trẻ trung năng động.'),
(70, 2, 'Dép nam xỏ ngón da PU cao cấp', 'depnam9.jpg', '115000', '1', '', '1', 0, 'Dép xỏ ngón làm từ da PU bền đẹp, thoáng khí, thích hợp đi dạo, đi biển.'),
(71, 2, 'Dép nam quai ngang phối khóa', 'depnam10.jpg', '135000', '1', '', '1', 0, 'Phối khóa tinh tế, thời trang hiện đại.'),
(72, 2, 'Dép nam đế xuồng cá tính', 'depnam11.jpg', '145000', '1', 'Giảm 10k khi mua kèm áo', '1', 0, 'Thiết kế phá cách, năng động trẻ trung.'),
(73, 2, 'Dép nam da lộn quai kép', 'depnam12.jpg', '159000', '1', '', '1', 1, 'Da lộn mềm mịn, mang êm chân.'),
(74, 2, 'Dép nam chống trượt đi biển', 'depnam13.jpg', '99000', '1', '', '1', 0, 'Chống trượt, nhanh khô, phù hợp du lịch.'),
(75, 2, 'Dép nam thể thao Adidas phong cách', 'depnam14.jpg', '199000', '1', 'Sale cuối tuần', '1', 1, 'Thiết kế thể thao, in logo nổi bật.'),
(82, 2, 'Dép nam EVA siêu nhẹ đế cao 4cm', 'depnam_eva4cm.jpg', '145000', '1', 'Giảm 10%', '1', 0, 'Chất liệu EVA siêu nhẹ, đế cao êm chân, phù hợp đi học, đi chơi.'),
(77, 2, 'Dép nam vải jeans cá tính', 'depnam16.jpg', '139000', '1', 'Freeship đơn 150k', '1', 0, 'Chất liệu jeans phá cách, bền bỉ.'),
(78, 2, 'Dép nam 3 sọc thể thao', 'depnam17.jpg', '89000', '1', 'Giảm 20%', '1', 0, 'Đặc trưng 3 sọc mạnh mẽ, dễ phối đồ.'),
(79, 2, 'Dép nam quai da phối vải', 'depnam18.jpg', '125000', '1', '', '1', 0, 'Sự kết hợp giữa da và vải, cá tính hiện đại.'),
(80, 2, 'Dép nam đế massage êm chân', 'depnam19.jpg', '135000', '1', '', '1', 0, 'Đế massage nhẹ, giảm mỏi chân.'),
(81, 2, 'Dép nam dáng sandal hở mũi', 'depnam20.jpg', '159000', '1', '', '1', 1, 'Thiết kế sandal thoáng mát, dễ mang.');
...
--
ALTER TABLE `sanpham`
  MODIFY `id_sp` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;
COMMIT;
